        ...
        if(userAnswer===correctAnswers[index]){
         ...
         //show result on page 
          //Net Ninja way
            ...
            // if(score==100){
            //   result.textContent=`Fantastic You got an A+${score}%`;
            //   result.classList='d-block bg-success display-3 text-white text-center';
            // }else if(score==75){
            //     result.textContent=`Good You got an B+${score}% you can do better`;
            //     result.classList='d-block bg-primary display-3 text-white text-center';
            // }else if(score==50){
            //     result.textContent=`You got D ${score}%  Average needs to get better`;
            //     result.classList='d-block bg-warning display-3 text-white text-center';
            // }else{
            //     result.textContent=`Unfortunately you got F ${score}% .Better luck next time`;
